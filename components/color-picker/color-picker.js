...
template.innerHTML = /*html*/`
  ...
  <dialog part="selector">
    ...
    <label data-format="rgb" part="property-container" data-property="r" data-value-operation="Math.round(255 * {v})">
      ...
      <input-slider orientation="vertical" part="input-range" min="0" max="255" step="1" exportparts="slider-track,slider-thumb"></input-slider>
    </label>

    <label data-format="rgb" part="property-container" data-property="g" data-value-operation="Math.round(255 * {v})">
    ...
    <label data-format="rgb" part="property-container" data-property="b" data-value-operation="Math.round(255 * {v})">
    ...
    <label data-format="hsl hwb" part="property-container"  data-property="h"data-value-operation="Math.round({v})">
      ...
      <input-slider orientation="vertical" part="input-range" min="0" max="359" step="1" exportparts="slider-track,slider-thumb"></input-slider>
    </label>

    <label data-format="hsl" part="property-container" data-property="s" data-value-operation="Math.round(100 * {v})">
      ...
      <input-slider orientation="vertical" part="input-range" min="0" max="100" step="1" exportparts="slider-track,slider-thumb"></input-slider>
    </label>

    <label data-format="hsl" part="property-container" data-property="l" data-value-operation="Math.round(100 * {v})">
    ...
    <label data-format="hwb" part="property-container" data-property="w" data-value-operation="Math.round(100 * {v})">
    ...
    <label data-format="hwb" part="property-container" data-property="bk" data-value-operation="Math.round(100 * {v})">
    ...
    <label data-format="lab lch" part="property-container" data-property="ciel" data-value-operation="Math.round(100 * {v})">
    ...
    <label data-format="lab" part="property-container" data-property="ciea" data-value-operation="Math.round({v})">
      ...
      <input-slider orientation="vertical" part="input-range" min="-80" max="94" step="1" exportparts="slider-track,slider-thumb"></input-slider>
    </label>

    <label data-format="lab" part="property-container" data-property="cieb" data-value-operation="Math.round({v})">
      ...
      <input-slider orientation="vertical" part="input-range" min="-112" max="94" step="1" exportparts="slider-track,slider-thumb"></input-slider>
    </label>

    <label data-format="lch" part="property-container" data-property="ciec" data-value-operation="Math.round({v})">
      ...
      <input-slider orientation="vertical" part="input-range" min="0" max="132" step="1" exportparts="slider-track,slider-thumb"></input-slider>
    </label>

    <label data-format="lch" part="property-container" data-property="cieh" data-value-operation="Math.round({v})">
    ...
    <label data-format="oklab oklch" part="property-container" data-property="okl" data-value-operation="Math.round(100 * {v})">
    ...
    <label data-format="oklrab oklrch okhsl" part="property-container" data-property="oklr" data-value-operation="Math.round(100 * {v})">
    ...
    <label data-format="okhsv" part="property-container" data-property="okv" data-value-operation="Math.round(100 * {v})">
    ...
    <label data-format="oklab oklrab" part="property-container" data-property="oka" data-value-operation="Math.round(10**3 * {v}) / 10**3">
      ...
      <input-slider orientation="vertical" part="input-range" min="-0.24" max="0.28" step="0.001" exportparts="slider-track,slider-thumb"></input-slider>
    </label>

    <label data-format="oklab oklrab" part="property-container" data-property="okb" data-value-operation="Math.round(10**3 * {v}) / 10**3">
      ...
      <input-slider orientation="vertical" part="input-range" min="-0.32" max="0.20" step="0.001" exportparts="slider-track,slider-thumb"></input-slider>
    </label>

    <label data-format="oklch oklrch" part="property-container" data-property="okc" data-value-operation="Math.round(10**3 * {v}) / 10**3">
      ...
      <input-slider orientation="vertical" part="input-range" min="0" max="0.32" step="0.001" exportparts="slider-track,slider-thumb"></input-slider>
    </label>

    <label data-format="okhsl" part="property-container" data-property="oksl" data-value-operation="Math.round(100 * {v})">
    ...
    <label data-format="okhsv" part="property-container" data-property="oksv" data-value-operation="Math.round(100 * {v})">
    ...
    <label data-format="oklch oklrch okhsl okhsv" part="property-container" data-property="okh" data-value-operation="Math.round({v})">
    ...
    <label data-format="rgb hsl hwb lab lch oklab oklch oklrab oklrch okhsl okhsv" data-property="a" part="property-container" data-value-operation="Math.round(100 * {v})">
